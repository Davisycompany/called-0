const LOCAL_IP_ADDRESS = "https://servercvvservercvv.hop.sh"; // change it
...
//let socket = io.connect("https://servercvvservercvv.hop.sh");


// Kết nối với server
const socket = io('https://vnjrbdujf.onrender.com:443');
